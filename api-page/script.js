document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "LynnSatoru");
        setContent('header', 'textContent', settings.name || "LynnSatoru");
        setContent('name', 'textContent', settings.name || "LynnSatoru");
